...
<div className="max-w-7xl mx-auto px-4 flex items-center justify-between gap-4">
          <div className="flex items-center gap-15">
            ...
            {token && <div className=" relative text-white hidden md:flex items-center gap-1">
        ...
        <ul
          className={`absolute top-16 flex flex-col items-center justify-center font-semibold text-center bg-gray-200 transform transition text-indigo-500 left-0 w-full ${
            isOpen
