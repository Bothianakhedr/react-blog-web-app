    ...
    <section className="my-20">
      <div className="container shadow-lg rounded-lg justify-center md:py-15 md:mt-32 mx-auto md:flex items-center  gap-16">
        <div className="content text-center md:text-left  ">
          <h3 className="text-4xl text-indigo-500 font-semibold">Get In Touch</h3>
          <span className="text-indigo-400 italic my-4 block">I'd like to hear from you!</span>
          ...
          <div >
            <div className="flex items-center gap-4 mb-4 justify-center md:justify-start">
              <MdMarkEmailUnread />
              <a href="https://mail.google.com/" className="underline">bothianakhedr198@gmail.com</a>
            </div>
        ...
        <form className="form  mt-6 space-y-3">
